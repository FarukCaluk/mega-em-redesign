...
export default function TiltCard({ children, glow, className = '' }: { children: ReactNode; glow: string; className?: string }) {
  return (
    <motion.div
      whileHover={{ y: -4 }}
      whileTap={{ scale: 0.97 }}
      transition={{ type: 'spring', stiffness: 300, damping: 20 }}
      style={{ '--glow': glow, '--glow-shadow': `${glow}33` } as CSSProperties}
